...
cc.push("<span class=\"tree-title\" onselectstart=\"return false\">"+opts.formatter.call(_1c1,item)+"</span>");
cc.push("</div>");
if(item.children&&item.children.length){
...
cc.push("<span class=\"tree-title\" onselectstart=\"return false\" >"+val+"</span>");
}else{
cc.push(val);
}
}
