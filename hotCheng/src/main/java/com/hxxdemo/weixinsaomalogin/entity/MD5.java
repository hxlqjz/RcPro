...
/*	private static boolean isValidChar(char ch) {  
	...
	*/
	public Map<String, String> sendRedPack(String opendid,String totalAmount,String hbname,String zfy) throws KeyStoreException, NoSuchAlgorithmException, IOException,
	...
	String mch_id = "1508862741";//商户号
	String appid = "wx8666da66ca071393";
	//String opendid = "od1hc1ezHucolmlIPfcFiMFvKDy8"; //发送给指定微信用户的openid 观前同学
	...
	sendRedPackPo.setSend_name(hbname);//商户名称
	sendRedPackPo.setRe_openid(opendid);
	sendRedPackPo.setTotal_amount(totalAmount);
	sendRedPackPo.setTotal_num("1");
	sendRedPackPo.setWishing(zfy);//红包祝福语
	sendRedPackPo.setClient_ip("10.0.216.1"); //调用接口的机器Ip地址
	sendRedPackPo.setAct_name("恭喜发财");//活动名称
	sendRedPackPo.setRemark("恭喜发财");//备注信息
	...
	String key = "&key=LGBsTtQtgnAmweZi4ZrdVm3497Z9dYJ1"; //商户支付密钥
	...
	KeyStore keyStore  = KeyStore.getInstance("PKCS12");
	        FileInputStream instream = new FileInputStream(new File("E:\\cert\\apiclient_cert.p12")); //此处为证书所放的绝对路径
	        try {
