 ...
 */
@Entity
@Table(name="rc_car_dis_query")
public class RcCarDisQuery  implements Serializable{
	...
	public String getCarDisQuery() {
		return carDisQuery;
	}
	public void setCarDisQuery(String carDisQuery) {
		this.carDisQuery = carDisQuery;
	}
