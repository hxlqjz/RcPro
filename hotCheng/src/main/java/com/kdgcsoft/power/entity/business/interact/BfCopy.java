...
@Entity
@Table(name="bf_copy")
public class BfCopy implements Serializable{
	...
	private String bm5;
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE,generator="bf_copy")
	@TableGenerator(name="bf_copy",table="TB_GENERATOR", pkColumnName="gen_key", valueColumnName="gen_value", pkColumnValue = "bf_copy",allocationSize = 1)
