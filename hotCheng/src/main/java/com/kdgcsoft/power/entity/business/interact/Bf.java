...
public class Bf implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE,generator="bf")
	@TableGenerator(name="bf",table="TB_GENERATOR", pkColumnName="gen_key", valueColumnName="gen_value", pkColumnValue = "bf",allocationSize = 1)
