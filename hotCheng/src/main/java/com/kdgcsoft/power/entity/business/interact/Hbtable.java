...
@Entity
@Table(name="hbtable")
public class Hbtable implements Serializable{
	...
	private String bds4;
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE,generator="hbtable")
	@TableGenerator(name="hbtable",table="TB_GENERATOR", pkColumnName="gen_key", valueColumnName="gen_value", pkColumnValue = "hbtable",allocationSize = 1)
